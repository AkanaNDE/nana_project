...
class Gamepad:
    ...
    def reset_toggles(self):
        # Reset all buttons and axes to 0.0
        self.lx = 0.0
        self.ly = 0.0
        self.l2 = 1.0
        self.rx = 0.0
...
class Joystick(Node):
    def __init__(self):
        ...
        self.pub_maho = self.create_publisher(
        ...
        self.pub_drill = self.create_publisher(
            Twist, "/nana/cmd_drill", qos_profile=qos.qos_profile_system_default
)
    ...
    def sendData(self):
        ...
        cmd_drill.linear.y = float(self.gamepad.button_square)
