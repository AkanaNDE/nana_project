...
class Drive_node(Node):
    ...
    def __init__(self):
        ...
        self.send_robot_speed = self.create_publisher(
            Twist, "/nana/cmd_move/rpm", qos_profile=qos.qos_profile_system_default
        )

        self.create_subscription(
            Twist, '/nana/cmd_move', self.cmd_vel, qos_profile=qos.qos_profile_system_default
        )
    ...
    def cmd_vel(self, msg):
        ...
        self.motor1Speed = rpm_right * -1
        self.motor2Speed = rpm_left * -1
